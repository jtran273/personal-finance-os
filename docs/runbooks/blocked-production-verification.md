# Runbook: Blocked production verification checklist (#111, #112, #236)

Issues #111, #112, and #236 are blocked on production credentials, signed-in
browser actions, or private account data. Do not guess from local behavior and
do not paste secrets, raw provider payloads, provider ids, tokens, database
URLs, or service-role keys into issues, PRs, chat, or logs.
