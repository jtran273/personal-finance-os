...
test("normalizeReimbursementClarificationAnswer leaves vague prose unknown", () => {
  assert.deepEqual(normalizeReimbursementClarificationAnswer("not sure"), {
    counterparties: [],
    kind: "unknown",
    rawAnswer: "not sure"
  });
  assert.deepEqual(normalizeReimbursementClarificationAnswer("maybe Ryan"), {
    counterparties: [],
    kind: "unknown",
    rawAnswer: "maybe Ryan"
  });
});
