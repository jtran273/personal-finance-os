...
values
  ...
  ('40000000-0000-0000-0000-000000000015', '11111111-1111-1111-1111-111111111111', 'Education', '#435fb6', 'graduation-cap', true),
  ('40000000-0000-0000-0000-000000000016', '11111111-1111-1111-1111-111111111111', 'Entertainment', '#be185d', 'ticket', true),
  ('40000000-0000-0000-0000-000000000017', '11111111-1111-1111-1111-111111111111', 'Auto / Car Maintenance', '#2563eb', 'car-front', true)
on conflict (user_id, name) do update set
  color = excluded.color,
  icon = excluded.icon,
